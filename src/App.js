  ...
  render() {
    ...
    return (
      <div className="app">
        ...
        <Option value={this.state.workTime} timer="workTime" updateLength={this.updateLength.bind(this)}>Work Time</Option>
        <Option value={this.state.breakTime} timer="breakTime" updateLength={this.updateLength.bind(this)}>Break Time</Option>
      </div>
    )
  }
}
...
class Time extends React.Component {
  ...
  render() {
    ...
    var activeTimer = this.props.active === 'workTime' ? 'Get coding!' : 'Take a little break';
